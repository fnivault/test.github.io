...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-377622.149377, 6064252.708418, -372940.081900, 6067853.089534], maxZoom: 28, minZoom: 1
    })
});


map.getView().fit([-377622.149377, 6064252.708418, -372940.081900, 6067853.089534], map.getSize());
